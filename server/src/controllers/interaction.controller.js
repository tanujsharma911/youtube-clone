...
const toggleVideoInteraction = asyncHandler(async (req, res) => {
    ...
    const userInteraction = await Interaction.findOne({ user_id: user._id.toString(), commentId: null, video: videoId });
    ...
    // user interacted
        ...
        if (String(userInteraction.action) === String(action)) {
            const deleteResult = await Interaction.deleteOne({ _id: userInteraction._id, commentId: null });
...
const toggleCommentInteraction = asyncHandler(async (req, res) => {
    ...
    const userInteraction = await Interaction.findOne({ user_id: user._id.toString(), commentId: commentId });
